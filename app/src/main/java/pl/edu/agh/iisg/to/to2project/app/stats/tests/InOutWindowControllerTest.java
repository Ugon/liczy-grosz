...
public class InOutWindowControllerTest {
    private IBasicDataSource mock = new IBasicDataSourceImpl();
    ...
    public void testCreateLineChartDataNotNull() throws Exception {
        ObservableList<XYChart.Series<String, BigDecimal>> result = InOutWindowController.createLineChartData(mock2, from, to, mock.getAccounts(), mock.getCategories());
