package pl.edu.agh.iisg.to.to2project.app.stats.inout_graph_panel.view;
 ...
 */
public class InOutWindow extends Application{
    ...
    public InOutWindow(List<Account> acc, List<Category> cat, LocalDate dateFrom, LocalDate dateTo) {
        this.accounts = acc;
        this.categories = cat;
    ...
    private void initRootLayout() {
        try {
            ...
            AnnotationConfigApplicationContext context =
                    new AnnotationConfigApplicationContext(InOutWindow.class);

            String resource = PropertiesUtil.GRAPHWINDOW_WINDOW_RESOURCE_INOUT;
