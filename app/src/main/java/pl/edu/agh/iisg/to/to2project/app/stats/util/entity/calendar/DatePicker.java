package pl.edu.agh.iisg.to.to2project.app.stats.util.entity.calendar;
...
public class DatePicker extends HBox {
    ...
    private void showPopup() {
        ...
        if (!isBudget)
        {
            posX = countXPopupPostion(calendarBounds,bounds);
            posY = countDefaultYYPopupPostion(calendarBounds,bounds);
        } else
        {
            posX = countXPopupPostion(calendarBounds,bounds);
            posY = countBudgettYPopupPostion(calendarBounds,bounds);
        }
