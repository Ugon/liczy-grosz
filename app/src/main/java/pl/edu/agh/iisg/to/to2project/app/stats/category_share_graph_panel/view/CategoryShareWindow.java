package pl.edu.agh.iisg.to.to2project.app.stats.category_share_graph_panel.view;
 ...
 */
public class CategoryShareWindow extends Application {
    ...
    public CategoryShareWindow(List<Account> acc, List<Category> cat, LocalDate dateFrom, LocalDate dateTo) {
        this.accounts = acc;
        this.categories = cat;
    ...
    private void initRootLayout() {
        try {
            ...
            AnnotationConfigApplicationContext context =
                    new AnnotationConfigApplicationContext(CategoryShareWindow.class);

            String resource = PropertiesUtil.CATEGORYGRAPHWINDOW_WINDOW_RESOURCE;
